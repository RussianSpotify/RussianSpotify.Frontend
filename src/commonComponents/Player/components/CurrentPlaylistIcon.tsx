    ...
    return (
        <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <g id="SVGRepo_iconCarrier">
                <path opacity="0.5" d="M21 6L3 6" stroke="#CDCDCD" strokeWidth="1.5" strokeLinecap="round"></path>
                <path opacity="0.5" d="M21 10L3 10" stroke="#CDCDCD" strokeWidth="1.5" strokeLinecap="round"></path>
                <path opacity="0.5" d="M11 14L3 14" stroke="#CDCDCD" strokeWidth="1.5" strokeLinecap="round"></path>
                <path opacity="0.5" d="M11 18H3" stroke="#CDCDCD" strokeWidth="1.5" strokeLinecap="round"></path>
                <path
                    ...
                    stroke="#9370DB" strokeWidth="1.5"></path>
            </g>
        </svg>
    )
};